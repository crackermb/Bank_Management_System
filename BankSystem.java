...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		delRec.setAccelerator (KeyStroke.getKeyStroke(KeyEvent.VK_D, InputEvent.CTRL_MASK));
	...
	String makeRecordPrint (int rec) {
		...
		String data6 = "          Copyright © 2022 Mehul Bhatia and Team.\n";	//Page Footer.
		String sep0 = " -----------------------------------------------------------\n";
		String sep1 = " -----------------------------------------------------------\n";
		String sep2 = " -----------------------------------------------------------\n";
		String sep3 = " -----------------------------------------------------------\n";
